...
class InterestsViewController: UIViewController {
    ...
    let moreDetailsArray: [String] = [
        """
        Занимаюсь спортом всю свою сознательную жизнь, но бегать начал относительно недавно,
        краткосрочная цель - пробежать minsk half marathon (21 км) в начале сентября.
        """,
